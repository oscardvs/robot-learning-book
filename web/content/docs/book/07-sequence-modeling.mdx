...
<Figure id="fig-flamingo" number="7.6" src="/slides/lecture07/slide_028.jpg" scale="78%" videoUrl="https://www.youtube.com/watch?v=imSTfMJjp7M&t=2019s" timecode="33:39" lecture="7">
  Flamingo's gated cross-attention. A <InlineMath tex={"\\tanh"} /> gate initialized at zero means the augmented model starts out identical to the pre-trained language model and opens the visual pathway only as training warrants. Credit: course slides, Lecture 7.
</Figure>
...
<Figure id="fig-chunk" number="7.9" src="/slides/lecture07/slide_034.jpg" scale="80%" videoUrl="https://www.youtube.com/watch?v=imSTfMJjp7M&t=2570s" timecode="42:50" lecture="7">
  Action chunking with temporal ensembling: predict <InlineMath tex={"H"} /> actions at once for smoothness, re-query every step, and combine the overlapping predictions with exponentially decaying weights to stay reactive. Credit: course slides, Lecture 7.
</Figure>
